%% Tracés des positions de départ et d'arrivée des robots
%
...
for i = 1:nombre_objets
    ...
    hold on;
    depart=plot(yunit, xunit,T(i).couleur); % image -> figure  (x,y) -> (y,x) correction V1.6
    %
    ...
    hold on;
    arrivee=plot(yunit, xunit, T(i).couleur); % image -> figure  (x,y) -> (y,x) correction V1.6
end