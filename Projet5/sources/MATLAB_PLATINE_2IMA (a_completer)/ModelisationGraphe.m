% anasquel6; analyse d'un squelette (*** version 1.9 ***)
%anasquel7 % V1.10
anasquel8 % V1.11
%
...
distance1; % calcul des distances entre les sommets du graphe
% Le nom de ce script a ete change de distance en distance1
